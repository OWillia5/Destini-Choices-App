...
struct StoryBrain{
    ...
    mutating func nextStory(_ userchoice: String){
        if storyNumber + 1 < stories.count - 1{
            storyNumber += 1
        } else {
            storyNumber = 0
        }
    ...
    mutating func nextStory2(_ userchoice:String){
        if storyNumber + 2 < stories.count {
            storyNumber += 2
        } else {
            storyNumber = 0
        }
    ...
    func getChoiceOne() -> String{
        return stories[storyNumber].choice1 //use c1d instead of story number
    }
    
    //retrieve choice2
    func getChoiceTwo() -> String{
        return stories[storyNumber].choice2 //use c2d instead of story number
    }
